//
//		Conatainment vs Aggregation 
//
//
//	Conatainment: Here, IMul is outer component.Since, Isub is inner component,
//				it cant give u outer component.
//				So, to access all component functions, u have to take it from outer 
//				componnt only!!!

//Aggregation: U can get any component from any other component.Since, Iunknown's
//				of inner and outer components are shared.
//
//
...
)
{
	...
	do
	{
		...
		case 1:
			...
			//
			//	FLAW: Here, IMul is outer component.Since, Isub is inner component,
			//	it cant give u outer component.
			//	So, to access all component functions, u have to take it from outer 
			//	componnt only!!!

			hr = pIsum->QueryInterface(IID_mul, (void**)&pImul);
			if(FAILED(hr))
			{
				cout<<"\nQueryInterface failed for multiplication";
				break;
			}
